...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2018 at 04:53 AM
...
(159, 'ï»¿C01', 'Komputer', 'Laptop', 'C01/027/XI/2016', 15000000, ' MAC ', 'Elektro', 2016, 11, 'Kantor Pusat Gasnet', '-', NULL),
...
--
ALTER TABLE `inventaris`
  MODIFY `IDinventaris` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=321;
